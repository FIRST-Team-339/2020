...
public static void init ()
{
    ...
    /*
     * pos switch for starting location: forward : left reverse : right off :
     * center
     */
...
private static void choosePath ()
{
    ...
    /*
     * 3 pos switch: 1: shoot far 2: shoot close 3: dont move kForward = shoot
     * far
        ...
        if (position == Position.LEFT)
            ...
            switch (square)
                ...
                case DRIVE_BACK:
                    ...
                    if (Hardware.drive.driveStraightInches(
                            ALIGN_SQUARE_MOVE_BACK_DISTANCE,
                            -DRIVE_SPEED,
                            ACCELERATION, true))
                        {
...
private static boolean getOut ()
{
    ...
    switch (out)
        ...
        case TURN:
            ...
            if (position == Position.RIGHT)
                {
                if (Hardware.drive.turnDegrees(GET_OUT_RIGHT_DEGREES,
                        TURN_SPEED, ACCELERATION, true))
                    {
            ...
            if (position == Position.RIGHT)
                ...
                if (position == Position.LEFT)
                    ...
                    if (Hardware.drive.driveStraightInches(
                            ...
                            -GET_OUT_CENTER_SPEED, ACCELERATION,
                            true))
                        {
                        out = GetOutState.FINIHS;
                        }
