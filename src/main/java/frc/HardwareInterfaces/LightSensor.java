...
// -------------------------------------------------------
/**
 * This function tells us whether this ;oght sensor returns
 * false instead of true for ON.
 *
 * @method isReversed
 ...
 * The value can be changed based upon whether or not
 * the isReversed flag is set
 *
 * @method isOn
