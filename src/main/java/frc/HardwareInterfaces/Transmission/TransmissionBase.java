...
public abstract class TransmissionBase {
     ...
     *
     * @param magnitude How fast the robot will travel (0.0 to 1.0)
     * @param direction In which direction, laterally, will the robot travel
    ...
    /**
     * Sets the current gear for the robot. This will change the maximum speed of
     * the robot for precise aiming/driving.
     *
