...
public class CANNetwork
    ...
    public void pinCurrentPrint(int pinNumber)
    {
        ...
        System.out.println("Port " + String.format("%1$02d", pinNumber) + " Amps " + this.pdp.getCurrent(pinNumber));
    ...
    /**
     * prints out the currents of all ports on the PDP that are being used -has not
     * been tested, is found commented out in print statements in teleop
     *
     * @author Cole Ramos
     *
     **/
